...
if __name__ == "__main__":
    print("Fetching page 57:1716 (Icons) metadata...")
    res = fetch_metadata("57:1716", 6666)
    if res:
        ...
        with open("page_icons.xml", "w") as f:
            f.write(xml_content)
        print("Saved page XML to page_icons.xml")
        
        nodes = ["128:6", "127:3", "128:15", "128:12", "128:9", "128:18", "128:21", "128:24"]
        lines = xml_content.split("\n")
        for node in nodes:
            print(f"\nSearching for node {node} in Icons XML:")
            found = False
            ...
            if not found:
                print(f"Node {node} not found in page 57:1716")
    else:
        print("Failed to fetch Icons page metadata.")
